# -*- encoding: utf-8 -*-
# stub: dry-struct 1.3.0 ruby lib
...
Gem::Specification.new do |s|
  ...
  s.add_runtime_dependency(%q<dry-core>.freeze, ["~> 0.4".freeze, ">= 0.4.4".freeze])
  s.add_runtime_dependency(%q<dry-equalizer>.freeze, ["~> 0.3".freeze])
  s.add_runtime_dependency(%q<dry-types>.freeze, ["~> 1.3".freeze])
