...
Gem::Specification.new do |s|
  ...
  s.add_runtime_dependency(%q<rom-core>.freeze, ["~> 5.2".freeze, ">= 5.2.3".freeze])
  s.add_runtime_dependency(%q<rom-repository>.freeze, ["~> 5.2".freeze, ">= 5.2.2".freeze])
  s.add_runtime_dependency(%q<rom-changeset>.freeze, ["~> 5.2".freeze, ">= 5.2.3".freeze])
